                ...
                children: <Widget>[
                  TextFormField(
                    decoration: InputDecoration(
                      ...
                      labelText: "Hatırlatılacak ilacı giriniz",
                      hintText: "Hatırlatılacak ilacı giriniz",
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Card(
                        color: Colors.grey.shade700,
                        child: TextButton(
                          child: Text("Hatırlatıcı Oluştur",style: TextStyle(color: Colors.white),),
                          onPressed: () {
                            if (formKey.currentState.validate()) {
                              formKey.currentState.save();
        ...
        if (direction == DismissDirection.endToStart) {
          final bool res = await showDialog(
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                  content: Text(
                      "Bu Hatırlatıcıyı Silmek İstediğinize Emin misiniz ?:  '${tumHatirlaticiListesi[index].isim}'"),
                  actions: <Widget>[
                    Row(
