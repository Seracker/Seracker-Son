...
class Igne extends StatefulWidget {
  @override
  _IgneState createState() => _IgneState();
}

class _IgneState extends State<Igne> {
                ...
                children: <Widget>[
                  TextFormField(
                    decoration: InputDecoration(
                      ...
                      labelText: "Hatırlatılacak iğneyi giriniz",
                      hintText: "Hatırlatılacak iğneyi giriniz",
                    ...
                    onSaved: (kaydedilecekDeger) {
                      ...
                      setState(
                        ...
                        _hatirlaticiEkle(Hatirlatici("2",hatirlaticiIgne, sct.substring(0,10),scs.substring(10,15)));
                        },
                      );
                    },
                  ),
...
/*class HatirlaticiIgneListesi {
  ...
  ///seçilen saat
  HatirlaticiIgneListesi(this.igneAdi, this.st, this.ss);
}
*/